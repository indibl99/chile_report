...
def gaussianFits(fileName, fobs, outLoc, SN):
    ...
    if tooNoisy==False: 
        ...
        #Halpha = integrate.simps(y[3054:3075], x[3054:3075])
        #NII = integrate.simps(y[3075:3100], x[3075:3100])
        #SII = integrate.simps(y[3211:3240], x[3211:3240])
...
def run_code():
    ...
    base = base[-24:-4]
    print('base: ' + base)
    outpath = '/Users/plira/india_temp/variable_spectra/auto/output_spectra/'
    starlight = '/Users/plira/software/STARLIGHTv04/'
    oldFile = 'old'
    totalFile = '/Users/plira/india_temp/variable_spectra/auto/cumulative_output_update.txt'
    totalBPT = '/Users/plira/india_temp/variable_spectra/auto/cumulative_BPT_update.txt'
